...
import { createPost, getPosts, updatePost, deletePost, getPublicPosts, getPostById, likePublicPost, getPostDepartments, getPostDepartmentCounts, trackPostView, getPostEngagement } from '../controllers/postController';
...
router.get('/public/departments', getPostDepartments);
router.get('/public/department-counts', getPostDepartmentCounts);
router.get('/public/:id', getPostById);
router.post('/public/:id/like', likePublicPost);
router.post('/public/:id/view', trackPostView);
